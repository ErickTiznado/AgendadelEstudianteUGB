        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/update-bloque/" method="POST" id="editForm">
                    ...
                    <div class="modal-body">
                        <!-- Campo oculto para el ID del bloque -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="editFin" name="fin">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- Botón de Eliminar -->
                        <button type="button" class="btn btn-danger" id="deleteBlockBtn" data-id="">Eliminar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            calendar.on('clickSchedule', function(event) {
                ...
                document.getElementById('editDescripcion').value = schedule.body?.descripcion || ''; 
                document.getElementById('editNotas').value = schedule.body?.notas || ''; 
